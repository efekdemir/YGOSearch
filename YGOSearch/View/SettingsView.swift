...
struct SettingsView: View {
    ...
    var body: some View {
        NavigationView {
            Form {
                Section(header: Text("Appearance").adjustableFontSize()) {
                    Toggle(isOn: $isDarkMode) {
                        Text("Dark Mode").adjustableFontSize()
                    }
                ...
                Section(header: Text("Other Settings").adjustableFontSize()) {
                    Text("Version: 1.0.0").adjustableFontSize()
                }
            }
